...
@WebServlet(name = "NewsEditServlet", urlPatterns = {"/NewsEditServlet"})
...
public class NewsEditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NewsEditServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewsEditServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Noticia_Categoria> categorias = CategoriaDAO.getCats(cards);
        cards.setCats(categorias);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Noticia article = new Noticia(title,summary,subtitle,content);
        
        NoticiasDAO.editNews(article, id_noticia);
